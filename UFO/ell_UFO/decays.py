...
Decay_chi = Decay(name = 'Decay_chi',
                  particle = P.chi,
                  partial_widths = {(P.Scabar,P.e__minus__):'((mchi**2 - msca**2)*(lambda1**2*mchi**2 - lambda1**2*msca**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scabar,P.mu__minus__):'((mchi**2 - msca**2)*(lambda2**2*mchi**2 - lambda2**2*msca**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scabar,P.ta__minus__):'((lambda3**2*mchi**2 - lambda3**2*msca**2 + lambda3**2*MTA**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MTA**2 - 2*msca**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(mchi)**3)'})
...
Decay_Sca = Decay(name = 'Decay_Sca',
                  particle = P.Sca,
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.Sca,P.chi):'((lambda3**2*mchi**2 - lambda3**2*msca**2 + lambda3**2*MTA**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MTA**2 - 2*msca**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.Scabar,P.Sca):'(((-4*ee**2*msca**2*sw**2)/cw**2 + (ee**2*MZ**2*sw**2)/cw**2)*cmath.sqrt(-4*msca**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
