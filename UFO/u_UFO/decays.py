...
Decay_chi = Decay(name = 'Decay_chi',
                  particle = P.chi,
                  partial_widths = {(P.phibar,P.c):'((mchi**2 - Mphi**2)*(3*lambda2**2*mchi**2 - 3*lambda2**2*Mphi**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.phibar,P.t):'((3*lambda3**2*mchi**2 - 3*lambda3**2*Mphi**2 + 3*lambda3**2*MT**2)*cmath.sqrt(mchi**4 - 2*mchi**2*Mphi**2 + Mphi**4 - 2*mchi**2*MT**2 - 2*Mphi**2*MT**2 + MT**4))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.phibar,P.u):'((mchi**2 - Mphi**2)*(3*lambda1**2*mchi**2 - 3*lambda1**2*Mphi**2))/(32.*cmath.pi*abs(mchi)**3)'})
...
Decay_phi = Decay(name = 'Decay_phi',
                  particle = P.phi,
                  partial_widths = {(P.c,P.chi__tilde__):'((-mchi**2 + Mphi**2)*(-3*lambda2**2*mchi**2 + 3*lambda2**2*Mphi**2))/(48.*cmath.pi*abs(Mphi)**3)',
                                    (P.t,P.chi__tilde__):'((-3*lambda3**2*mchi**2 + 3*lambda3**2*Mphi**2 - 3*lambda3**2*MT**2)*cmath.sqrt(mchi**4 - 2*mchi**2*Mphi**2 + Mphi**4 - 2*mchi**2*MT**2 - 2*Mphi**2*MT**2 + MT**4))/(48.*cmath.pi*abs(Mphi)**3)',
                                    (P.u,P.chi__tilde__):'((-mchi**2 + Mphi**2)*(-3*lambda1**2*mchi**2 + 3*lambda1**2*Mphi**2))/(48.*cmath.pi*abs(Mphi)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.phi,P.chi):'((3*lambda3**2*mchi**2 - 3*lambda3**2*Mphi**2 + 3*lambda3**2*MT**2)*cmath.sqrt(mchi**4 - 2*mchi**2*Mphi**2 + Mphi**4 - 2*mchi**2*MT**2 - 2*Mphi**2*MT**2 + MT**4))/(96.*cmath.pi*abs(MT)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.phibar,P.phi):'(((-16*ee**2*Mphi**2*sw**2)/(3.*cw**2) + (4*ee**2*MZ**2*sw**2)/(3.*cw**2))*cmath.sqrt(-4*Mphi**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
