...
Decay_chi = Decay(name = 'Decay_chi',
                  particle = P.chi,
                  partial_widths = {(P.Sca0__tilde__,P.ve):'((mchi**2 - msca0**2)*(lambda1**2*mchi**2 - lambda1**2*msca0**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Sca0__tilde__,P.vm):'((mchi**2 - msca0**2)*(lambda2**2*mchi**2 - lambda2**2*msca0**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Sca0__tilde__,P.vt):'((mchi**2 - msca0**2)*(lambda3**2*mchi**2 - lambda3**2*msca0**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scap,P.e__minus__):'((mchi**2 - msca**2)*(lambda1**2*mchi**2 - lambda1**2*msca**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scap,P.mu__minus__):'((mchi**2 - msca**2)*(lambda2**2*mchi**2 - lambda2**2*msca**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scap,P.ta__minus__):'((lambda3**2*mchi**2 - lambda3**2*msca**2 + lambda3**2*MTA**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MTA**2 - 2*msca**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(mchi)**3)'})
...
Decay_Sca0 = Decay(name = 'Decay_Sca0',
                   particle = P.Sca0,
                   partial_widths = {(P.Scam,P.W__plus__):'((-((ee**2*msca**2)/sw**2) - (ee**2*msca0**2)/sw**2 + (ee**2*msca**4)/(2.*MW**2*sw**2) - (ee**2*msca**2*msca0**2)/(MW**2*sw**2) + (ee**2*msca0**4)/(2.*MW**2*sw**2) + (ee**2*MW**2)/(2.*sw**2))*cmath.sqrt(msca**4 - 2*msca**2*msca0**2 + msca0**4 - 2*msca**2*MW**2 - 2*msca0**2*MW**2 + MW**4))/(16.*cmath.pi*abs(msca0)**3)',
                                     (P.ve,P.chi__tilde__):'((-mchi**2 + msca0**2)*(-(lambda1**2*mchi**2) + lambda1**2*msca0**2))/(16.*cmath.pi*abs(msca0)**3)',
                                     (P.vm,P.chi__tilde__):'((-mchi**2 + msca0**2)*(-(lambda2**2*mchi**2) + lambda2**2*msca0**2))/(16.*cmath.pi*abs(msca0)**3)',
                                     (P.vt,P.chi__tilde__):'((-mchi**2 + msca0**2)*(-(lambda3**2*mchi**2) + lambda3**2*msca0**2))/(16.*cmath.pi*abs(msca0)**3)'})

Decay_Scam = Decay(name = 'Decay_Scam',
                   particle = P.Scam,
                   partial_widths = {(P.e__minus__,P.chi__tilde__):'((-mchi**2 + msca**2)*(-(lambda1**2*mchi**2) + lambda1**2*msca**2))/(16.*cmath.pi*abs(msca)**3)',
                                     (P.mu__minus__,P.chi__tilde__):'((-mchi**2 + msca**2)*(-(lambda2**2*mchi**2) + lambda2**2*msca**2))/(16.*cmath.pi*abs(msca)**3)',
                                     (P.Sca0,P.W__minus__):'((-((ee**2*msca**2)/sw**2) - (ee**2*msca0**2)/sw**2 + (ee**2*msca**4)/(2.*MW**2*sw**2) - (ee**2*msca**2*msca0**2)/(MW**2*sw**2) + (ee**2*msca0**4)/(2.*MW**2*sw**2) + (ee**2*MW**2)/(2.*sw**2))*cmath.sqrt(msca**4 - 2*msca**2*msca0**2 + msca0**4 - 2*msca**2*MW**2 - 2*msca0**2*MW**2 + MW**4))/(16.*cmath.pi*abs(msca)**3)',
                                     (P.ta__minus__,P.chi__tilde__):'((-(lambda3**2*mchi**2) + lambda3**2*msca**2 - lambda3**2*MTA**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MTA**2 - 2*msca**2*MTA**2 + MTA**4))/(16.*cmath.pi*abs(msca)**3)'})
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.Scam,P.chi):'((lambda3**2*mchi**2 - lambda3**2*msca**2 + lambda3**2*MTA**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MTA**2 - 2*msca**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.c,P.s__tilde__):'(ee**2*MW**4)/(16.*cmath.pi*sw**2*abs(MW)**3)',
                                          (P.Sca0,P.Scap):'((-((ee**2*msca**2)/sw**2) - (ee**2*msca0**2)/sw**2 + (ee**2*msca**4)/(2.*MW**2*sw**2) - (ee**2*msca**2*msca0**2)/(MW**2*sw**2) + (ee**2*msca0**4)/(2.*MW**2*sw**2) + (ee**2*MW**2)/(2.*sw**2))*cmath.sqrt(msca**4 - 2*msca**2*msca0**2 + msca0**4 - 2*msca**2*MW**2 - 2*msca0**2*MW**2 + MW**4))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.Sca0__tilde__,P.Sca0):'((-2*ee**2*msca0**2 + (ee**2*MZ**2)/2. - (cw**2*ee**2*msca0**2)/sw**2 + (cw**2*ee**2*MZ**2)/(4.*sw**2) - (ee**2*msca0**2*sw**2)/cw**2 + (ee**2*MZ**2*sw**2)/(4.*cw**2))*cmath.sqrt(-4*msca0**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.Scap,P.Scam):'((2*ee**2*msca**2 - (ee**2*MZ**2)/2. - (cw**2*ee**2*msca**2)/sw**2 + (cw**2*ee**2*MZ**2)/(4.*sw**2) - (ee**2*msca**2*sw**2)/cw**2 + (ee**2*MZ**2*sw**2)/(4.*cw**2))*cmath.sqrt(-4*msca**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
