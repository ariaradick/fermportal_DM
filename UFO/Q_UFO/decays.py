...
Decay_b = Decay(name = 'Decay_b',
                particle = P.b,
                partial_widths = {(P.Scad,P.chi):'((3*I2b3*MB**2*complexconjugate(I2b3) + 3*I2b3*mchi**2*complexconjugate(I2b3) - 3*I2b3*msca**2*complexconjugate(I2b3))*cmath.sqrt(MB**4 - 2*MB**2*mchi**2 + mchi**4 - 2*MB**2*msca**2 - 2*mchi**2*msca**2 + msca**4))/(96.*cmath.pi*abs(MB)**3)',
...
Decay_chi = Decay(name = 'Decay_chi',
                  particle = P.chi,
                  partial_widths = {(P.Scadb,P.b):'((3*I1b3*MB**2*complexconjugate(I1b3) + 3*I1b3*mchi**2*complexconjugate(I1b3) - 3*I1b3*msca**2*complexconjugate(I1b3))*cmath.sqrt(MB**4 - 2*MB**2*mchi**2 + mchi**4 - 2*MB**2*msca**2 - 2*mchi**2*msca**2 + msca**4))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scadb,P.d):'((mchi**2 - msca**2)*(3*I1b1*mchi**2*complexconjugate(I1b1) - 3*I1b1*msca**2*complexconjugate(I1b1)))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scadb,P.s):'((mchi**2 - msca**2)*(3*I1b2*mchi**2*complexconjugate(I1b2) - 3*I1b2*msca**2*complexconjugate(I1b2)))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scaub,P.c):'((mchi**2 - msca**2)*(3*lambda2**2*mchi**2 - 3*lambda2**2*msca**2))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scaub,P.t):'((3*lambda3**2*mchi**2 - 3*lambda3**2*msca**2 + 3*lambda3**2*MT**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MT**2 - 2*msca**2*MT**2 + MT**4))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.Scaub,P.u):'((mchi**2 - msca**2)*(3*lambda1**2*mchi**2 - 3*lambda1**2*msca**2))/(32.*cmath.pi*abs(mchi)**3)'})
...
Decay_Scad = Decay(name = 'Decay_Scad',
                   particle = P.Scad,
                   partial_widths = {(P.b,P.chi__tilde__):'((-3*I1b3*MB**2*complexconjugate(I1b3) - 3*I1b3*mchi**2*complexconjugate(I1b3) + 3*I1b3*msca**2*complexconjugate(I1b3))*cmath.sqrt(MB**4 - 2*MB**2*mchi**2 + mchi**4 - 2*MB**2*msca**2 - 2*mchi**2*msca**2 + msca**4))/(48.*cmath.pi*abs(msca)**3)',
                                     (P.d,P.chi__tilde__):'((-mchi**2 + msca**2)*(-3*I1b1*mchi**2*complexconjugate(I1b1) + 3*I1b1*msca**2*complexconjugate(I1b1)))/(48.*cmath.pi*abs(msca)**3)',
                                     (P.s,P.chi__tilde__):'((-mchi**2 + msca**2)*(-3*I1b2*mchi**2*complexconjugate(I1b2) + 3*I1b2*msca**2*complexconjugate(I1b2)))/(48.*cmath.pi*abs(msca)**3)'})

Decay_Scau = Decay(name = 'Decay_Scau',
                   particle = P.Scau,
                   partial_widths = {(P.c,P.chi__tilde__):'((-mchi**2 + msca**2)*(-3*lambda2**2*mchi**2 + 3*lambda2**2*msca**2))/(48.*cmath.pi*abs(msca)**3)',
                                     (P.t,P.chi__tilde__):'((-3*lambda3**2*mchi**2 + 3*lambda3**2*msca**2 - 3*lambda3**2*MT**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MT**2 - 2*msca**2*MT**2 + MT**4))/(48.*cmath.pi*abs(msca)**3)',
                                     (P.u,P.chi__tilde__):'((-mchi**2 + msca**2)*(-3*lambda1**2*mchi**2 + 3*lambda1**2*msca**2))/(48.*cmath.pi*abs(msca)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.Scau,P.chi):'((3*lambda3**2*mchi**2 - 3*lambda3**2*msca**2 + 3*lambda3**2*MT**2)*cmath.sqrt(mchi**4 - 2*mchi**2*msca**2 + msca**4 - 2*mchi**2*MT**2 - 2*msca**2*MT**2 + MT**4))/(96.*cmath.pi*abs(MT)**3)',
...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.c,P.s__tilde__):'(ee**2*MW**4)/(16.*cmath.pi*sw**2*abs(MW)**3)',
                                          (P.Scadb,P.Scau):'(((-6*ee**2*msca**2)/sw**2 + (3*ee**2*MW**2)/(2.*sw**2))*cmath.sqrt(-4*msca**2*MW**2 + MW**4))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.Scadb,P.Scad):'((-2*ee**2*msca**2 + (ee**2*MZ**2)/2. - (3*cw**2*ee**2*msca**2)/sw**2 + (3*cw**2*ee**2*MZ**2)/(4.*sw**2) - (ee**2*msca**2*sw**2)/(3.*cw**2) + (ee**2*MZ**2*sw**2)/(12.*cw**2))*cmath.sqrt(-4*msca**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.Scaub,P.Scau):'((2*ee**2*msca**2 - (ee**2*MZ**2)/2. - (3*cw**2*ee**2*msca**2)/sw**2 + (3*cw**2*ee**2*MZ**2)/(4.*sw**2) - (ee**2*msca**2*sw**2)/(3.*cw**2) + (ee**2*MZ**2*sw**2)/(12.*cw**2))*cmath.sqrt(-4*msca**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
